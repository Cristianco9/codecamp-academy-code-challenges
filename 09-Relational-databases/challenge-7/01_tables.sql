...
CREATE TABLE room (
    ...
    number_room     VARCHAR(10) NOT NULL UNIQUE,
...
CREATE TABLE appointment (
    ...
    patient_id_appointment     INT  NOT NULL,
    ...
    CONSTRAINT fk_appointment_patient
        FOREIGN KEY (patient_id_appointment) REFERENCES patient (id_patient)
        ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE INDEX idx_appointment_patient       ON appointment (patient_id_appointment);
